...
import { listPartnerAction, deletePartnerAction, resetPartnerCreate, resetPartnerUpdate, resetPartnerDelete } from '../../../store/actions/partnerActions';
...
const ListPartner = () => {
    ...
    const { success: successDelete,
        error: errorDelete } = partnerDelete;
