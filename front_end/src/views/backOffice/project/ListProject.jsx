...
import { PlusCircleOutlined, EyeOutlined, DeleteOutlined, EditOutlined } from '@ant-design/icons';
import { Button, Modal, Space, Spin, Table, notification } from 'antd';
import './listProject.css';
import { useNavigate } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { listProjectAction, deleteProjectAction, resetProjectCreate, resetProjectUpdate, resetProjectDelete } from '../../../store/actions/projectActions';
...
const ListProject = () => {
    ...
    const [modalText, setModalText] = useState('Voulez-vous vraiment supprimer cet élément?');
    ...
    const { success: successDelete,
        error: errorDelete } = projectDelete;
...

        {
            ...
            render: (_, record) => (
                <Space size="middle" >
                    <Button
                        type="primary"
                        style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#91caff' }}
                        shape="round"
                        icon={<EyeOutlined />}
                    ...
                    <Button
                        type="primary"
                        style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffa940' }}
                        shape="round"
                        icon={<EditOutlined />}
                    ...
                    <Button
                        type="primary"
                        style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#ff7875' }}
                        shape="round"
                        icon={<DeleteOutlined />}
            ...
            <Spin style={{ marginTop: '20%' }} spinning={loadingSpiner} tip="" size="large">
                ...
                <div className='main-page'>
                    ...
                    <Button
                        ...
                        style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#93C572', float: 'right', margin: '20px' }}>
                        Ajouter
                    </Button>
