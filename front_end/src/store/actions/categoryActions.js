...
//function get all
export const listCategoryAction = (currentPage, perPage) => async (dispatch) => {
    ...
    try {
        ...
        const response = await axiosClient.get("/categorie?page=" +
            currentPage +
            "&per_page=" +
            perPage);
...
//function update
export const updateCategoryAction = (id, category) => async (
    dispatch,
) => {
    try {
        dispatch({
