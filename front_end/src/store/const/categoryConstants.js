...
export const CATEGORY_GET_MODEL_REQUEST = "CATEGORY_GET_MODEL_REQUEST";
export const CATEGORY_GET_MODEL_SUCCESS = "CATEGORY_GET_MODEL_SUCCESS";
export const CATEGORY_GET_MODEL_FAIL = "CATEGORY_GET_MODEL_FAIL";
